(function($,undefined){
  ...
  var defaults = {
    ...
    // 消息内容
    content: '<span class="ui-artdialog-loading">Loading..</span>',
    ...
    innerHTML:
      '<div i="dialog" class="ui-artdialog">'
        +       '<div class="ui-artdialog-arrow-a"></div>'
        +       '<div class="ui-artdialog-arrow-b"></div>'
        +       '<table class="ui-artdialog-grid">'
        +           '<tr>'
        +               '<td i="header" class="ui-artdialog-header">'
        +                   '<button i="close" class="ui-artdialog-close">&#215;</button>'
        +                   '<div i="title" class="ui-artdialog-title"></div>'
        +               '</td>'
        +           '</tr>'
        +           '<tr>'
        +               '<td i="body" class="ui-artdialog-body">'
        +                   '<div i="content" class="ui-artdialog-content"></div>'
        +               '</td>'
        +           '</tr>'
        +           '<tr>'
        +               '<td i="footer" class="ui-artdialog-footer">'
        +                   '<div i="statusbar" class="ui-artdialog-statusbar"></div>'
        +                   '<div i="button" class="ui-artdialog-button"></div>'
        +               '</td>'
        +           '</tr>'
        +       '</table>'
        +'</div>'
        ...
        $.each(args, function (i, val) {
          ...
          html +=
            '<button'
              ...
              + (val.autofocus ? ' autofocus class="ui-artdialog-autofocus"' : '')
              + '>'
              +   val.value
              + '</button>';
