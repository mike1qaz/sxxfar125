    		...
    		<div class="row">
    			<div class="col-xs-12 hidden-sm col-md-5">
    				...
    				<div class="about-left">
    					<img src="/static/img/about/about1.jpg" alt="">
    				</div>
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-sm-4 col-md-2">
						<span></span><img src="/static/img/client/client1.png" alt="">
					</div>

					<div class="col-sm-4 col-md-2">
						<span></span><img src="/static/img/client/client2.png" alt="">
					</div>

					<div class="col-sm-4 col-md-2">
						<span></span><img src="/static/img/client/client3.png" alt="">
					</div>

					<div class="col-sm-4 col-md-2">
						<span></span><img src="/static/img/client/client4.png" alt="">
					</div>

					<div class="col-sm-4 col-md-2">
						<span></span><img src="/static/img/client/client5.png" alt="">
					</div>

					<div class="col-sm-4 col-md-2">
						<span></span><img src="/static/img/client/client6.png" alt="">
					</div>
				...
				<div class="row">
					...
					<div class="col-md-4">
						<div class="footer-heading">
							...
							<div class="insta">
								<ul>
									<img src="/static/img/footer/footer1.jpg" alt="">
									<img src="/static/img/footer/footer2.jpg" alt="">
									<img src="/static/img/footer/footer3.jpg" alt="">
									<img src="/static/img/footer/footer4.jpg" alt="">
									<img src="/static/img/footer/footer5.jpg" alt="">
									<img src="/static/img/footer/footer6.jpg" alt="">
								</ul>
							</div>
						</div>
					</div>
